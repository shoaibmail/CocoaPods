...
if [ "${SCRIPT_OUTPUT_FILE_LIST_COUNT}" -gt "0" ]; then
  SUCCESS_FILE=$(tail -n 1 "${SCRIPT_OUTPUT_FILE_LIST_0}")
else
  COUNT=$(($SCRIPT_OUTPUT_FILE_COUNT-1))
  SUCCESS_FILE=SCRIPT_OUTPUT_FILE_$COUNT
fi
